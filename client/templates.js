(function (root, factory) {
    ...
    templatizer["pages"]["roulette"] = function tmpl_pages_roulette() {
        return '<section class="page roulette"><h1 data-hook="headline" class="roulette-headline">0.00</h1><div class="panel panel-default roulette-panel"><div class="panel-heading clearfix roulette-heading"><span data-hook="heading-prefix-verb" class="verb roulette-owed"></span> <a data-hook="heading-balance-url">@<span data-hook="heading-user" class="subject"></span></a> <span data-hook="heading-suffix-verb" class="verb roulette-owes"></span><div data-hook="heading-amount-container" class="panel-heading-rhs"><span class="currency">$ </span><span data-hook="heading-amount" class="amount"></span></div></div><div data-hook="neighbors" class="list-group roulette-neighbors"></div></div><div data-hook="no-neighbors" class="roulette-no-neighbors">Nobody here! :-(</div><div data-hook="features-missing" class="alert alert-danger roulette-features-missing">Sorry! IOU Roulette requires a browser with <a href="http://html5test.com/compare/feature/location-geolocation/communication-eventSource.html">Geolocation and Server-Sent Events</a></div><div data-hook="geo-permission-denied" class="alert alert-danger roulette-geo-permission-denied">IOU Roulette needs to know your location in order to find other users nearby. <a href="#" data-hook="retry" class="roulette-geo-enable">Let\'s try again</a></div><div data-hook="geo-position-unavailable" class="alert alert-danger roulette-geo-position-unavailable">Position unavailable. <a href="#" data-hook="retry" class="roulette-geo-enable">Let\'s try again</a></div><div data-hook="geo-timeout" class="alert alert-danger roulette-geo-timeout">Timeout trying to determine your position. <a href="#" data-hook="retry" class="roulette-geo-enable">Let\'s try again</a></div><div data-hook="geo-error" class="alert alert-danger roulette-geo-error">Unable to determine your position: <span data-hook="geo-error-message" class="roulette-geo-error-message"></span> <a href="#" data-hook="retry" class="roulette-geo-enable">Let\'s try again</a></div><div data-hook="post-error" class="alert alert-danger roulette-post-error">Unable to contact server. <a href="#" data-hook="retry" class="roulette-geo-enable">Let\'s try again</a></div></section>';
    };
